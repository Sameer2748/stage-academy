...
export default function AiInsightCard({ insight }: AiInsightCardProps) {
  return (
    <Card className="col-span-3 relative overflow-hidden bg-white border-slate-200">
      ...
      <CardContent className="pt-6 relative z-10">
        <div className="flex items-start gap-4">
          <div className="bg-purple-500/20 p-2 rounded-lg shrink-0 border border-purple-200">
